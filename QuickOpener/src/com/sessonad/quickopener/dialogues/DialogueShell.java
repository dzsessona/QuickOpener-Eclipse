...
public class DialogueShell extends JDialog {
	...
	public DialogueShell(java.awt.Frame parent, boolean modal,final IWorkbenchWindow window){
		super(parent,modal);
		setIconImage(Toolkit.getDefaultToolkit().getImage(DialogueShell.class.getResource("/com/sessonad/quickopener/icons/terminal-cu.png")));
	...
	public void initComponents() {
		...
		}
		{
			...
			panel.setLayout(gbl_panel);
			{
				...
				lblNewLabel_1.setIcon(new ImageIcon(DialogueCommands.class.getResource("/com/sessonad/quickopener/icons/terminal48-cu2.png")));
			...
			}
			{
				...
				{
					JLabel lblNewLabel_2 = new JLabel("Open shell in:");
	...
	public static void main(String[] args) {
		try {
			DialogueShell dialog = new DialogueShell(null,true,null);
