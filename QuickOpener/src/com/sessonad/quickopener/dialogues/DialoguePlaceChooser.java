...
public class DialoguePlaceChooser extends JDialog {
	...
	public static String getPlaceSelected() {
		return placeSelected;
	}

	public DialoguePlaceChooser(java.awt.Frame parent, boolean modal,String selPath, String selProj, String selWks,final IWorkbenchWindow window){
		super(parent,modal);
		setIconImage(Toolkit.getDefaultToolkit().getImage(DialogueShell.class.getResource("/com/sessonad/quickopener/icons/folder-documents-icon.png")));
		setTitle("Choose a place...");
		initComponents();
		placeSelected=null;
		
		this.selectioPath=selPath;
		this.mainProjectPath=selProj;
		this.workbenchPath=selWks;
		try {	
	...
	public void initComponents() {
		...
		}
		{
			...
			panel.setLayout(gbl_panel);
			{
				...
				lblNewLabel_1.setIcon(new ImageIcon(DialogueCommands.class.getResource("/com/sessonad/quickopener/icons/folder-documents-icon48.png")));
			...
			}
			{
				...
				{
					JLabel lblNewLabel_2 = new JLabel("Choose place:");
	...
	public static void main(String[] args) {
		try {
			DialoguePlaceChooser dialog = new DialoguePlaceChooser(null,true,null, null, null,null);
